...
<html>
    ...
    <body>
        ...
        <%
                ...
                int id = Integer.parseInt(Training_ID) ;
                Trainings_Management T = new Trainings_Management();
                ArrayList<Training> Trainings = T.get_Trainings();
                ArrayList<String> Training_Skills = T.get_Training_skills(id);
        ...
        <table style="text-align: center; width: 1000px ; padding-left: 500px">
            <tr>
                <td > <h1 > <% out.print(Trainings.get(id-1).getName());%></h1></td>
                
            </tr>
            
            <tr>
                
                <td > <h4 style="color: #0492C2;" > <% out.print(Trainings.get(id-1).getDescription());%></h4></td>
            </tr>
            ...
            <br><br>
                ...
                <tr>
                    ...
                    <td style="color: #0492C2 ; font-size: 25px" ><h4 style="color: black "> Required Skills: </h4> <% out.print(Training_Skills);%></td>
            </tr>
            ...
            <tr>
                ...
                <td> <div class="bar" >
                        <div class="dropdown">
                            <br>
                            <h3>Click the button below to enroll</h3><br>
                            <button class="B_Training" href=Enroll_Training.jsp?myUL=<%out.print(id);%>>  Enroll </button>

...
<%@page import="Algorithms.Evaluation.Charts"%>
...
<%
    ...
    Charts c = new Charts();
    String empID =  request.getParameter("myUL");
    int id ;
    id = Integer.parseInt(empID);
    Map<Object,Object> map = null;
    List<Map<Object,Object>> list = new ArrayList<Map<Object,Object>>();
    list = c.employee_Scores(id) ;
...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Employee Score Chart</title>
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
	        ...
	        exportFileName: "Employee Score Analysis",
                title: {
                        text: "Employee Scores (History)"
                },
                axisX: {
                        title: "Date"
                },

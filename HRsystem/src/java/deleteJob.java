...
public class deleteJob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(jobHandling.deleteJobByID(ID)){
            
            out.println("<html>");
            
            out.println("<body>");
                out.println("<script>");
            out.println("alert('The Job is deleted.')");
            ...
            out.println("<body>");
                out.println("<script>");
            out.println("alert('The Job is not deleted.')");
            out.println("window.location.replace('recuHome.jsp');");
            out.println("</script>");
            out.println("</body>");
            out.println("</html>");}
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(deleteJob.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

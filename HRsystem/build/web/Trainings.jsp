<%-- 
    Document   : Trainings
    Created on : Mar 23, 2021, 6:42:03 PM
    Author     : Zak
--%>
...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center">View our Posted Trainings</h1>
        
        <h2 style="text-align: center">(<% out.print(All_Trainings.size());%>) Trainings</h2>
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Training.." title="Type in a name">
        ...
        <ul id="myUL">
            ...
            <%
                ...
                {%>
                   <li><a href=viewTraining.jsp?myUL=<% out.print(All_Trainings.get(i).getID());%>> <% out.print(All_Trainings.get(i).getName());%> </a></li>
                       <% }
                    } else { %> <p>There are no current Training.</p>
                    <% }%>

...
<html>
    <head>
        ...
        <link rel="stylesheet" href="cssCashadvance.css">
    </head>
    <body>
        <div class="navBar">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <h2 style="text-align: left" class="head">Cash Reward Details</h2>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <%= salary.get(i).getReason()%></td>
                        <td> <%= salary.get(i).getAmount()%></td>
                        <td><a class="btn btn-success" href="editCash.jsp?id=<%= salary.get(i).getEmployeeID()%>" role="button">Edit</a>
                            <a class="btn btn-danger" href="removeCash.jsp?id=<%= salary.get(i).getEmployeeID()%>" role="button">Remove</a>
                    </tr>
                    <% }
                        } catch (Exception ex) {
                            out.println("ex: " + ex);

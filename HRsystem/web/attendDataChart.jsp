<%-- 
    Document   : attendDataChart
    Created on : Jul 20, 2021, 1:36:50 AM
    Author     : egypt2
--%>
...
body {
    ...
    <body>
        ...
        <div class="container">
        <form id="contain" method="post" action="attendanceChart.jsp" class="form-horizontal">
        <div class="form-group">
            <h2> Arrival Time Analysis for Specific Employee </h2> <br>
                ...
                <div class="form-group">
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4 mx-auto"> 
                        <label for="firstname"> Enter Month Name </label>
                        <input type="text" name="monthh" class="form-control" id ="first">
                    </div>
                </div>
                <div class="form-group" >
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4 mx-auto"> 
                        <label for="lastname"> Enter Year </label>
                        <input type="text" name="yearr" class="form-control" id ="last">
                    </div>
                </div>
            <br>

...
<html>
    <head>
        ...
        <title>Training Management Section</title>
        <style>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link"  href="homePage.jsp">HOME</a>
                  ...
                  <h1 id= "head1" align = "center">Training Management</h1>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block" src="Corporate-Training.jpeg">
    </div>
    <div class="carousel-item">
      <img class="d-block" src="Homepage-TrainMang.jpeg">
    </div>
    <div class="carousel-item">
      <img class="d-block" src="t.jpeg">
  ...
  <a class="carousel-control-next" href="#headerSlider" role="button" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
        ...
        <div class = "container">
        <button class = "btn-primary" onclick="window.location.href='addTraining.jsp' ">Add Training</button><br/>
        <button class = "btn-primary" onclick="window.location.href='acceptanceTrain.jsp'">Training List and Charts</button><br/>

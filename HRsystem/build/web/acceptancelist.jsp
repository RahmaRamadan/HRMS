<%-- 
    Document   : acceptancelist
    Created on : Jul 25, 2021, 5:39:10 PM
    Author     : egypt2
--%>

<%@page import="Entity.Training_Acceptance"%>
       ...
       <div class="navBar">
        ...
        <nav class="sidebar">
            ...
            <ul>
              ...
              employees = t.acceptt(id);
                %>
                <br> 
                <br>
                <br>
                <h2 style="text-align: center; color:#0492C2; font-weight:bold ">(<% out.print(employees.size());%>) Accepted Employees in Training</h2>
                <br><br>
        ...
        %>
                ...
                <tr>
                    <th scope="row"> <%= employees.get(i).getTrainingID() %></th>
                    <td> <%=employees.get(i).getEmployeeID() %></td>
                    <td> <%=employees.get(i).getScore() %></td>

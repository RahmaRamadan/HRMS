<%-- 
    Document   : acceptanceTrain
    Created on : Jul 25, 2021, 5:30:16 PM
    Author     : egypt2
--%>
...
<html>
    <head>
        ...
        <title>Training List and Charts</title>
    ...
    <body>
        ...
        <div class="center">
            <form action="Trainings_Charts.jsp">
                <br><br>
                        <label id="lll" for="tID"> Enter Training ID </label>
                        <input class="form-control m-input" type="text" name="tID" value="" required/>
                      
                
                    <br>
                    <div class = "container">
        <button class = "btn-primary" onclick="window.location.href='Trainings_Charts.jsp' ">Training Gender Chart</button><br/>
        
        </div>
                    </form>
              <form action="acceptancelist.jsp">
                    ...
                    <br>
                    <div class = "container">
        <button class = "btn-primary" onclick="window.location.href='acceptancelist.jsp'">Training List</button><br/>

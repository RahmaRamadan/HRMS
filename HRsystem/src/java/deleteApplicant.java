 ...
 * @author maria
 */
@WebServlet(urlPatterns = {"/deleteApplicant"})
public class deleteApplicant extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (jobHandling.deleteApplicant(applicantID)) {

                out.println("<html>");
                out.println("<body>");
                out.println("<script>");
                out.println("alert('The Applicant is deleted.')");
                ...
                out.println("<body>");
                out.println("<script>");
                out.println("alert('failed to delete the applicant.')");
                out.println("window.location.replace('showJob.jsp?jobID="+jobID+"');");
                out.println("</script>");
                out.println("</body>");
                out.println("</html>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(deleteApplicant.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

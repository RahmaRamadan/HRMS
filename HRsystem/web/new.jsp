...
<html>
    <head>
       ...
       <script type="text/javascript">
        ...
        <%int k ;%>
         <% for( k = 0 ; k< All_Trainings.size() ; k++)%>
         <%{%>

              data.addRows([<%=All_Trainings.get(k).getID()%>, <%=All_Trainings.get(k).getName()%>,<%=All_Trainings.get(k).getStart_Date()%>, <%=All_Trainings.get(k).getEnd_Date()%> , null, 100, null]);
